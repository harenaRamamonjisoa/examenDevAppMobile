...
fun Application.configureDependencyInjection() {
    ...
    val options = ConnectionFactoryOptions.builder()
        ...
        .option(ConnectionFactoryOptions.HOST, "aws-0-eu-west-1.pooler.supabase.com")
        .option(ConnectionFactoryOptions.PORT, 5432)
        .option(ConnectionFactoryOptions.USER, "postgres.izypigctwekxrcyugchv")
        .option(ConnectionFactoryOptions.PASSWORD, "ekipaMandoro")
